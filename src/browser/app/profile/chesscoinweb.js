...
pref("extensions.systemAddon.update.url", "https://liveexplorer.chesscoin032.com/browser/addons/%CHANNEL%/update.xml");
pref("extensions.systemAddon.update.enabled", true);

//Update Routes (Download page for manual download and Temperoraliy Discord Invite Link for Release Notes)
pref("app.update.url.manual", "https://liveexplorer.chesscoin032.com/browser/download");
pref("app.update.url.details", "https://liveexplorer.chesscoin032.com/browser/download");
pref("app.releaseNotesURL", "https://github.com/OleksandrAAA/ChessCoinWeb-Firefox/blob/main/README.md");
pref("app.releaseNotesURL.aboutDialog", "https://github.com/OleksandrAAA/ChessCoinWeb-Firefox/blob/main/README.md");
